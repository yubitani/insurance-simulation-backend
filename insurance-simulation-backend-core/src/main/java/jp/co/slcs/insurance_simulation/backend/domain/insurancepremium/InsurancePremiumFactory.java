...
public enum InsurancePremiumFactory {
  ...
  DEATHINSURANCE("DeathInsurance-001", new DeathInsurancePremium()), MEDICALINSURANCE(
      "MedicalInsurance-001", new MedicalInsurancePremium()), CANCERINSURANCE("CancerInsurance-001",
          new CancerInsurancePremium());

  private final String productCode;
  private final InsurancePremium insurancePremium;

  private InsurancePremiumFactory(String productCode, InsurancePremium insurancePremium) {
