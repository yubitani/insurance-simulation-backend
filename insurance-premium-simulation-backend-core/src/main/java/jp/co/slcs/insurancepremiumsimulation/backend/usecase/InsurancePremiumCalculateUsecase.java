...
import jp.co.slcs.insurancepremiumsimulation.backend.domain.insurancepremium.InsurancePremium;
import jp.co.slcs.insurancepremiumsimulation.backend.domain.insurancepremium.InsurancePremiumFactory;
...
import jp.co.slcs.insurancepremiumsimulation.backend.usecase.exception.InvalidInputFormatException;
...
public class InsurancePremiumCalculateUsecase {
	...
	public int invoke(
			@NonNull LocalDate inputBirthday, @NonNull String inputSex, @NonNull String productCode,
			@NonNull String benefitCode, @NonNull String periodOfInsuranceCode,
		...
		try {
			...
			int result = insurancePremium.insurancePremiumCalculate(localDate, birthday,
													sex, benefitCode,periodOfInsuranceCode, optionList);
