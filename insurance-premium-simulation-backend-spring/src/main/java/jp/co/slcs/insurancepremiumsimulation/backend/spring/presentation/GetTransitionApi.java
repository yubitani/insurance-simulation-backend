...
import jp.co.slcs.insurancepremiumsimulation.backend.spring.queryService.SpringStatisticQueryService;
import jp.co.slcs.insurancepremiumsimulation.backend.usecase.GetTransitionUsecase;
import jp.co.slcs.insurancepremiumsimulation.backend.usecase.GetTransitionUsecase.TransitionData;
