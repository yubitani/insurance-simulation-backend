package jp.co.slcs.insurancepremiumsimulation.backend.spring.repository;

import java.time.LocalDateTime;
import java.util.List;
import org.springframework.stereotype.Repository;
import jp.co.slcs.insurancepremiumsimulation.backend.domain.entity.DocumentRequest;
import jp.co.slcs.insurancepremiumsimulation.backend.domain.entity.DocumentRequest.DocumentRequestProduct;
