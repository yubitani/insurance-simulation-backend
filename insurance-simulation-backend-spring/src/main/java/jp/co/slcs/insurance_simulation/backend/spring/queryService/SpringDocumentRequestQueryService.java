...
public class SpringDocumentRequestQueryService implements DocumentRequestQueryService {
	...
	public List<DocumentRequestList> fetchDocumentRequestLists() {
		...
		if (documentRequestDaoEntityList != null) {
			...
			BenefitChoices benefitChoiceBuild_1 = BenefitChoices.builder().benefitCode("5million")
					.benefitChoicesName("5,000,000円").build();
			benefitConditionList_1.add(benefitChoiceBuild_1);
			benefitChoiceBuild_1 = BenefitChoices.builder().benefitCode("10million").benefitChoicesName("10,000,000円")
					.build();
			benefitConditionList_1.add(benefitChoiceBuild_1);
			benefitChoiceBuild_1 = BenefitChoices.builder().benefitCode("15million").benefitChoicesName("15,000,000円")
					.build();
			benefitConditionList_1.add(benefitChoiceBuild_1);
			benefitChoiceBuild_1 = BenefitChoices.builder().benefitCode("20million").benefitChoicesName("20,000,000円")
					.build();
			benefitConditionList_1.add(benefitChoiceBuild_1);
			benefitChoiceBuild_1 = BenefitChoices.builder().benefitCode("25million").benefitChoicesName("25,000,000円")
					.build();
			benefitConditionList_1.add(benefitChoiceBuild_1);
			benefitChoiceBuild_1 = BenefitChoices.builder().benefitCode("30million").benefitChoicesName("30,000,000円")
					.build();
			benefitConditionList_1.add(benefitChoiceBuild_1);

			//保険期間選択肢を取得
			PeriodOfInsurance periodOfInsuranceBuild_1 = PeriodOfInsurance.builder().periodOfInsuranceCode("10years")
			...
			BenefitChoices benefitChoiceBuild_2 = BenefitChoices.builder().benefitCode("5000perday")
					.benefitChoicesName("5,000円").build();
			benefitConditionList_2.add(benefitChoiceBuild_2);
			benefitChoiceBuild_2 = BenefitChoices.builder().benefitCode("10000perday").benefitChoicesName("10,000円")
					.build();
			benefitConditionList_2.add(benefitChoiceBuild_2);

			//保険期間選択肢を取得
			PeriodOfInsurance periodOfInsuranceBuild_2 = PeriodOfInsurance.builder().periodOfInsuranceCode("lifetime")
					.periodOfInsuranceName("終身").build();
			...
			BenefitChoices benefitChoiceBuild_3 = BenefitChoices.builder().benefitCode("5000perday")
					.benefitChoicesName("5,000円").build();
			benefitConditionList_3.add(benefitChoiceBuild_3);
			benefitChoiceBuild_3 = BenefitChoices.builder().benefitCode("10000perday").benefitChoicesName("10,000円")
					.build();
			benefitConditionList_3.add(benefitChoiceBuild_3);

			//保険期間選択肢を取得
			PeriodOfInsurance periodOfInsuranceBuild_3 = PeriodOfInsurance.builder().periodOfInsuranceCode("lifetime")
					.periodOfInsuranceName("終身").build();
			...
			for (DocumentRequestDaoEntity documentRequestDaoEntity : documentRequestDaoEntityList) {
				...
				CustomerDaoEntity customerDaoEntity = customerDao.findById(documentRequestDaoEntity.getCustomerId())
						.get();

				List<SimulationDaoEntity> simulationDaoEntityList = simulationDao
						.findByReceiptNo(documentRequestDaoEntity.getReceiptNo());
				...
				for (SimulationDaoEntity simulationDaoEntity : simulationDaoEntityList) {
					...
					List<SimulationOptionDaoEntity> simulationOptionDaoEntityList = simulationOptionDao
							.findBySimulationId(simulationDaoEntity.getSimulationId());
